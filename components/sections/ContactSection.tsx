      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <form onSubmit={handleSubmit} className="mt-12 text-left">
          ...
          <div className="mt-8 flex justify-center">
            <button
              type="submit"
              className="w-full rounded bg-[#d1a893] px-10 py-3.5 text-sm font-semibold uppercase tracking-widest text-brand-brown transition-opacity hover:opacity-90 md:w-auto"
            >
              Schedule a visit
            </button>
          </div>
